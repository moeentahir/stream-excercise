...
//                .reduce(BigInteger.ONE, BigInteger::multiply);
        ...
        BigInteger result = Stream.iterate(BigInteger.ONE, i -> i.compareTo(BigInteger.valueOf(21)) <= 0, i -> i.add(BigInteger.ONE))
                .reduce(BigInteger::multiply)
                .orElse(BigInteger.ONE); // TODO
    ...
    public void e7_getLastWord() throws IOException {
        String result = reader
                .lines()
                .flatMap(SPLIT_PATTERN::splitAsStream)
                .reduce("", (partialStrin, current) -> current); // TODO
    ...
    public void e8_selectTheSuperClassesOfArrayList() {
        ...
        List<String> result = Stream.<Class<?>>iterate(origin, Objects::nonNull, Class::getSuperclass)
                .map(Class::toString)
                .collect(Collectors.toList()); // TODO

        Assertions.assertThat(result).containsExactly(
                ArrayList.class.toString(),
                AbstractList.class.toString(),
                AbstractCollection.class.toString(),
